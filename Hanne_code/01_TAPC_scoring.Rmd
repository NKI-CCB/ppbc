...
TAPC_plot_all_withoutlac <- ggboxplot(PPBC_metadata_withoutLAC, x="study_group", y="TAPC_score",
          ...
          ylab = "TAPC score", xlab = "study group") + 
  geom_dotplot(binaxis = "y", stackdir = "center", position = "dodge", binwidth = 0.05, aes(colour = study_group)) + stat_compare_means(method = "kruskal") + ylim(0,3.6) + stat_pvalue_manual(pwc, hide.ns = TRUE, y.position = c(3.2, 3.4))
