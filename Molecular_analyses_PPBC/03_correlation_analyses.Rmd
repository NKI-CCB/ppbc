...
```{r}
scatterplot_CD38_TAPC_v2 <- qplot(x = TAPC_score, y = TI_CD38_total, data = PPBC_metadata, color = "study_group") +
        geom_jitter(method = "lm") +
        ggtitle("Fig. A: Strong Positive Association")
scatterplot_CD38_TAPC_v2
```


```{r}
scatterplot_CD38_TAPC <- PPBC_metadata %>%
    ggplot(aes(x = TAPC_score, y = TI_CD38_total)) +
...
```{r}
scatterplot_CD38_TAPC_inv <- Data_inv %>%
    ggplot(aes(x = TAPC_score, y = TI_CD38_total)) +
...
```{r}
scatterplot_CD38_TAPC_inv_v2 <- qplot(x = TAPC_score, y = TI_CD38_total, data = Data_inv) +
        geom_jitter(method = "lm") 
scatterplot_CD38_TAPC_inv_v2
```
...
```{r}
scatterplot_IgA_TAPC <- PPBC_metadata %>%
...
```{r}
scatterplot_IgG_TAPC <- PPBC_metadata %>%
...
```{r}
scatterplot_IgA_TAPC_inv <- Data_inv %>%
    ggplot(aes(x = TAPC_score, y = IgA)) +
    geom_jitter() +
  geom_smooth(method = "lm") +
    #p value in stat_cor comes from `cor.test`
...
```{r}
scatterplot_IgG_TAPC_inv <- Data_inv %>%
    ggplot(aes(x = TAPC_score, y = IgG)) +
    geom_jitter() + geom_smooth(method = "lm") +
    #p value in stat_cor comes from `cor.test`
    ggpubr::stat_cor(method = "kendall",
...
```{r}
scatterplot_IgA_TAPC_prbc <- Data_prbc %>%
    ggplot(aes(x = TAPC_score, y = IgA)) +
    geom_jitter() + geom_smooth(method = "lm") +
    #p value in stat_cor comes from `cor.test`
    ggpubr::stat_cor(method = "kendall",
...
```{r}
scatterplot_IgG_TAPC_prbc <- Data_prbc %>%
    ggplot(aes(x = TAPC_score, y = IgG)) +
    geom_jitter() + geom_smooth(method = "lm") +
    #p value in stat_cor comes from `cor.test`
    ggpubr::stat_cor(method = "kendall",
...
```{r}
scatterplot_IgA_TAPC_npbc <- Data_npbc %>%
    ggplot(aes(x = TAPC_score, y = IgA)) +
    geom_jitter() + geom_smooth(method = "lm") +
    #p value in stat_cor comes from `cor.test`
    ggpubr::stat_cor(method = "kendall",
...
```{r}
scatterplot_IgG_TAPC_npbc <- Data_npbc %>%
    ggplot(aes(x = TAPC_score, y = IgG)) +
    geom_jitter() + geom_smooth(method = "lm") +
    #p value in stat_cor comes from `cor.test`
    ggpubr::stat_cor(method = "kendall",
...
```{r}
scatterplot_IgA_IgG <- PPBC_metadata %>%
    ggplot(aes(x = IgG, y = IgA)) +
    geom_jitter(aes(color = study_group)) + geom_smooth(method = "lm") +
    #p value in stat_cor comes from `cor.test`
    ggpubr::stat_cor(method = "kendall",
                     aes(label = paste(..r.label.., ..p.label.., sep = 
