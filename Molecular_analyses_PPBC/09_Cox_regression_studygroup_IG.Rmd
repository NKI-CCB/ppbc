...
#basd on filtered cases in MCP_Final without Lac
fit_SG_OS_nolac <- survfit(surv_OS_without_lac ~ study_group, data = MCP_Final_withoutLAC)
```
...
```
```{r}
ggsurvplot(fit_SG_OS_nolac, data = MCP_Final_withoutLAC, pval = TRUE, legend = "top", legend.labs = c("ppbcpw", "prbc", "npbc"), legend.title = "study group", title = "OS - Univariate Analysis", palette = c("#46CDCF","#AA96DA", "#521262"))
```
...
fit_SG_DR_nolac <- survfit(surv_DR_without_lac ~ study_group, data = MCP_Final_withoutLAC)
```
...
ggsurvplot(fit_SG_DR_nolac, data = MCP_Final_withoutLAC, pval = TRUE, legend = "top", legend.title = "study group",legend.labs = c("ppbcpw", "prbc", "npbc"), title = "distant_recurrence - Univariate Analysis", palette = c("#46CDCF","#AA96DA", "#521262"))
```
...
fit_IG_OS_withoutLAC <- survfit(surv_OS_without_lac ~ IG_ID, data = MCP_Final_withoutLAC)
```
...
ggsurvplot(fit_IG_OS_withoutLAC, data = MCP_Final_withoutLAC, pval = TRUE, legend = "top", legend.labs = c("high", "low", "medium"), legend.title = "IG cluster", title = "OS - Univariate Analysis", palette = c("#a10702", "#ffb600", "#ff7900"))
```
...
```{r, fig.width=7, fig.height=5}
plot_OS_IG_univariate_withoutLAC <- ggsurvplot(fit_IG_OS_withoutLAC, data = MCP_Final_withoutLAC,
    xlab = "Months", 
    ylab = "OS probability",
    #title =  paste0("OS univariate n = 184"),
    #linetype = "strata",
    ...
    test.for.trend = F,
    legend.labs = c("high (n=32)", "low (n=64)", "medium (n=88)"))
plot_OS_IG_univariate_withoutLAC
```
...
```{r}
#with PPBC
cox_OS_IG_cluster_multivariate <- coxph(Surv(time_OS_months, death) ~ IG_ID + PPBC + stage + clin_subtype, data = MCP_Final_withoutLAC)
...
study_strata <- coxph(
  Surv(time=time_OS_months,
       event=death) ~ stage + IG_ID + clin_subtype + strata(study_group), data = MCP_Final_withoutLAC)
study_strata
plot_OS_IG_multivariate <- ggadjustedcurves(study_strata, data=MCP_Final_withoutLAC, method="conditional", variable="study_group", palette = c("#46CDCF","#AA96DA", "#521262"), ggtheme = theme_bw()) + ggtitle("Adjusted survival curve for clinical covariates: Stratified")
plot_OS_IG_multivariate
```

"#a10702", "#ffb600", "#ff7900"
```{r}
#without study group as covariate 
study_strata <- coxph(
  Surv(time=time_OS_months,
       event=death) ~ stage + PPBC + clin_subtype + strata(IG_ID), data = MCP_Final_withoutLAC)
study_strata
ggadjustedcurves(study_strata, data=MCP_Final_withoutLAC, method="conditional", variable="IG_ID", palette = c("#a10702", "#ffb600", "#ff7900")) +
...
study_strata <- coxph(
  Surv(time=time_OS_months,
       event=death) ~ stage + PPBC + clin_subtype + strata(IG_ID), data = MCP_Final_withoutLAC)
study_strata
plot_OS_IG_multivariate <- ggadjustedcurves(study_strata, data=MCP_Final_withoutLAC, method="conditional", variable="IG_ID", palette = c("#a10702", "#ffb600", "#ff7900"), ggtheme = theme_bw()) + ggtitle("Adjusted survival curve for clinical covariates: Stratified")
plot_OS_IG_multivariate
```
...
fit_IG_DR_withoutLAC <- survfit(surv_DR_without_lac ~ IG_ID, data = MCP_Final_withoutLAC)
```
...
ggsurvplot(fit_IG_DR_withoutLAC, data = MCP_Final_withoutLAC, pval = TRUE, legend = "top", legend.title = "IG cluster",legend.labs = c("high", "low", "medium"), title = "DR - Univariate Analysis", palette = c("#a10702", "#ffb600", "#ff7900"))
```
...
```{r, fig.width=7, fig.height=5}
plot_DRS_IG_univariate_withoutLAC <- ggsurvplot(fit_IG_DR_withoutLAC, data = MCP_Final_withoutLAC,
    xlab = "Months", 
    ylab = "DRS probability",
    #title =  paste0("OS univariate n = 184"),
    #linetype = "strata",
    ...
    test.for.trend = F,
    legend.labs = c("high (n=32)", "low (n=64)", "medium (n=88)"))
plot_DRS_IG_univariate_withoutLAC
```
...
#### KM high vs low
```{r, fig.width=7, fig.height=5}
plot_DRS_IG_highVSlow <-  ggsurvplot(
    fit = survfit(Surv(time=time_DRS_months, event=distant_recurrence) ~ study_group + IG_ID, data = MCP_Final), 
    xlab = "Months", 
    ylab = "OS probability",
    title = "DRS - IG cluster by study-group",
...
```{r}
#univariate
cox_DR_IG_cluster <- coxph(Surv(time_DRS_months, distant_recurrence) ~ IG_ID, data = MCP_Final_withoutLAC)
...
```{r}
#with PPBC 
cox_DR_IG_cluster_multivariate <- coxph(Surv(time_DRS_months, distant_recurrence) ~ IG_ID + PPBC + stage + clin_subtype, data = MCP_Final_withoutLAC)
...
study_strata <- coxph(
  Surv(time=time_DRS_months,
       event=distant_recurrence) ~ stage + clin_subtype + PPBC + strata(IG_ID), data = MCP_Final_withoutLAC)
study_strata
plot_DRS_IG_multivariate <- ggadjustedcurves(study_strata, data=MCP_Final_withoutLAC, method="conditional", variable="IG_ID", palette = c("#a10702", "#ffb600", "#ff7900")) + ggtitle("Adjusted DR curve for clinical covariates: Stratified")
...
study_strata <- coxph(
  Surv(time=time_DRS_months,
       event=distant_recurrence) ~ stage + PPBC + clin_subtype + strata(IG_ID), data = MCP_Final_withoutLAC)
study_strata
plot_DRS_IG_multivariate <- ggadjustedcurves(study_strata, data=MCP_Final_withoutLAC, method="conditional", variable="IG_ID", palette = c("#a10702", "#ffb600", "#ff7900"), ggtheme = theme_bw()) + ggtitle("Adjusted survival curve for clinical covariates: Stratified")
plot_DRS_IG_multivariate
```
...
create TIL groups based on TILprecent

```{r}
table(MCP_Final_withoutLAC$TIL)
```
...
```{r}
MCP_Final_withoutLAC$TILmedian <- MCP_Final_withoutLAC$TILprecent > median(MCP_Final_withoutLAC$TILprecent, na.rm=T)
table(MCP_Final_withoutLAC$TILmedian)
```


Prof. Floris - ALSO check TIL based below or above 5%, 30% or 50% 

5%
```{r}
MCP_Final_withoutLAC <- MCP_Final_withoutLAC %>% mutate(TIL5 =
                     case_when(TILprecent <= 5 ~ "low", 
                               TILprecent > 5 ~ "high")
)
table(MCP_Final_withoutLAC$TIL5)
```


30%
```{r}
MCP_Final_withoutLAC <- MCP_Final_withoutLAC %>% mutate(TIL30 =
                     case_when(TILprecent <= 30 ~ "low", 
                               TILprecent > 30 ~ "high")
)
table(MCP_Final_withoutLAC$TIL30)
```

50%
```{r}
MCP_Final_withoutLAC <- MCP_Final_withoutLAC %>% mutate(TIL50 =
                     case_when(TILprecent <= 50 ~ "low", 
                               TILprecent > 50 ~ "high")
)
table(MCP_Final_withoutLAC$TIL50)
```

## OS 

```{r}
fit_TIL_OS <- survfit(surv_OS_without_lac ~ TIL, data = MCP_Final_withoutLAC)
fit_TIL_short_OS <- survfit(surv_OS_without_lac ~ TILmedian, data = MCP_Final_withoutLAC)
fit_TIL5 <- survfit(surv_OS_without_lac ~ TIL5, data = MCP_Final_withoutLAC)
fit_TIL30 <- survfit(surv_OS_without_lac ~ TIL30, data = MCP_Final_withoutLAC)
fit_TIL50 <- survfit(surv_OS_without_lac ~ TIL50, data = MCP_Final_withoutLAC)
```

### Kaplan-Meier

```{r, fig.width=7, fig.height=6}
ggsurvplot(fit_TIL_OS, data = MCP_Final_withoutLAC, pval = TRUE, legend = "top", legend.title = "TIL",legend.labs = c("high", "low", "medium"), palette = c("#a10702", "#ffb600", "#ff7900"), title = "OS - Univariate Analysis")

ggsurvplot(fit_TIL_short_OS, data = MCP_Final_withoutLAC, pval = TRUE, legend = "top", legend.title = "TIL",legend.labs = c("FALSE", "TRUE"), palette = c("#ffb600", "#a10702"), title = "OS - Univariate Analysis")

ggsurvplot(fit_TIL5, data = MCP_Final_withoutLAC, pval = TRUE, legend = "top", legend.title = "TIL",legend.labs = c("high", "low"), palette = c("#a10702", "#ffb600"), title = "OS - Univariate Analysis")

ggsurvplot(fit_TIL30, data = MCP_Final_withoutLAC, pval = TRUE, legend = "top", legend.title = "TIL",legend.labs = c("high", "low"), palette = c("#a10702", "#ffb600"), title = "OS - Univariate Analysis")

ggsurvplot(fit_TIL50, data = MCP_Final_withoutLAC, pval = TRUE, legend = "top", legend.title = "TIL",legend.labs = c("high", "low"), palette = c("#a10702", "#ffb600"), title = "OS - Univariate Analysis")
```
...
TIL_OS_studygroup <- ggsurvplot(
    fit = survfit(Surv(time=time_OS_months, event=death) ~ TILmedian + study_group, data = MCP_Final_withoutLAC), 
    xlab = "Months", 
    ylab = "Overall survival probability",
    title = "TIL median by study group",
    palette = c("#a10702", "#ffb600"),
    ggtheme = theme_bw(),
    pval = T, facet.by = "study_group")
TIL_OS_studygroup

TIL_OS_studygroup_TIL5 <- ggsurvplot(
    fit = survfit(Surv(time=time_OS_months, event=death) ~ TIL5 + study_group, data = MCP_Final_withoutLAC), 
    xlab = "Months", 
    ylab = "Overall survival probability",
    title = "TIL 5% by study group",
    palette = c("#a10702", "#ffb600"),
    ggtheme = theme_bw(),
    pval = T, facet.by = "study_group")
TIL_OS_studygroup_TIL5

TIL_OS_studygroup_TIL30 <- ggsurvplot(
    fit = survfit(Surv(time=time_OS_months, event=death) ~ TIL30 + study_group, data = MCP_Final_withoutLAC), 
    xlab = "Months", 
    ylab = "Overall survival probability",
    title = "TIL 30% by study group",
    palette = c("#a10702", "#ffb600"),
    ggtheme = theme_bw(),
    pval = T, facet.by = "study_group")
TIL_OS_studygroup_TIL30

TIL_OS_studygroup_TIL50 <- ggsurvplot(
    fit = survfit(Surv(time=time_OS_months, event=death) ~ TIL50 + study_group, data = MCP_Final_withoutLAC), 
    xlab = "Months", 
    ylab = "Overall survival probability",
    title = "TIL 50% by study group",
    palette = c("#a10702", "#ffb600"),
    ggtheme = theme_bw(),
    pval = T, facet.by = "study_group")
TIL_OS_studygroup_TIL50
```
...
TIL_OS_per_studygroup_without_lac <- ggsurvplot(
    fit = survfit(Surv(time=time_OS_months, event=death) ~ study_group + TILmedian, data = MCP_Final_withoutLAC ), 
    xlab = "Months", 
    ylab = "Overall survival probability",
    title = "TIL median by study group",
    palette = c("#46CDCF","#AA96DA", "#521262"),
    ggtheme = theme_bw(),
    pval = T, facet.by = "TILmedian")
TIL_OS_per_studygroup_without_lac

TIL_OS_per_studygroup_without_lac_TIL5 <- ggsurvplot(
    fit = survfit(Surv(time=time_OS_months, event=death) ~ study_group + TIL5, data = MCP_Final_withoutLAC ), 
    xlab = "Months", 
    ylab = "Overall survival probability",
    title = "TIL 5% by study group",
    palette = c("#46CDCF","#AA96DA", "#521262"),
    ggtheme = theme_bw(),
    pval = T, facet.by = "TIL5")
TIL_OS_per_studygroup_without_lac_TIL5

TIL_OS_per_studygroup_without_lac_TIL30 <- ggsurvplot(
    fit = survfit(Surv(time=time_OS_months, event=death) ~ study_group + TIL30, data = MCP_Final_withoutLAC ), 
    xlab = "Months", 
    ylab = "Overall survival probability",
    title = "TIL 30% by study group",
    palette = c("#46CDCF","#AA96DA", "#521262"),
    ggtheme = theme_bw(),
    pval = T, facet.by = "TIL30")
TIL_OS_per_studygroup_without_lac_TIL30

TIL_OS_per_studygroup_without_lac_TIL50 <- ggsurvplot(
    fit = survfit(Surv(time=time_OS_months, event=death) ~ study_group + TIL50, data = MCP_Final_withoutLAC ), 
    xlab = "Months", 
    ylab = "Overall survival probability",
    title = "TIL 50% by study group",
    palette = c("#46CDCF","#AA96DA", "#521262"),
    ggtheme = theme_bw(),
    pval = T, facet.by = "TIL50")
TIL_OS_per_studygroup_without_lac_TIL50
```
...
```{r}
cox_OS_TIL <- coxph(Surv(time_OS_months, death) ~ TILprecent, data = MCP_Final_withoutLAC)
summary(cox_OS_TIL)

cox_OS_TILmedian <- coxph(Surv(time_OS_months, death) ~ TILmedian, data = MCP_Final_withoutLAC)
summary(cox_OS_TILmedian)

cox_OS_TIL5 <- coxph(Surv(time_OS_months, death) ~ TIL5, data = MCP_Final_withoutLAC)
summary(cox_OS_TIL5)

cox_OS_TIL30 <- coxph(Surv(time_OS_months, death) ~ TIL30, data = MCP_Final_withoutLAC)
summary(cox_OS_TIL30)

cox_OS_TIL50 <- coxph(Surv(time_OS_months, death) ~ TIL50, data = MCP_Final_withoutLAC)
summary(cox_OS_TIL50)
```
...
cox_OS_TIL_multivariate <- coxph(Surv(time_OS_months, death) ~ TILprecent + study_group + stage + clin_subtype, data = MCP_Final_withoutLAC)
summary(cox_OS_TIL_multivariate)

cox_OS_TIL_multivariate_median <- coxph(Surv(time_OS_months, death) ~ TILmedian + study_group + stage + clin_subtype, data = MCP_Final_withoutLAC)
summary(cox_OS_TIL_multivariate_median)

cox_OS_TIL_multivariate_TIL5 <- coxph(Surv(time_OS_months, death) ~ TIL5 + study_group + stage + clin_subtype, data = MCP_Final_withoutLAC)
summary(cox_OS_TIL_multivariate_TIL5)

cox_OS_TIL_multivariate_TIL30 <- coxph(Surv(time_OS_months, death) ~ TIL30 + study_group + stage + clin_subtype, data = MCP_Final_withoutLAC)
summary(cox_OS_TIL_multivariate_TIL30)

cox_OS_TIL_multivariate_TIL50 <- coxph(Surv(time_OS_months, death) ~ TIL50 + study_group + stage + clin_subtype, data = MCP_Final_withoutLAC)
summary(cox_OS_TIL_multivariate_TIL50)
```
...
```{r}
MCP_Final_without_laclow <- subset(MCP_Final_withoutLAC , TILmedian %in% c("FALSE"), )
MCP_Final_without_lachigh <- subset(MCP_Final_withoutLAC , TILmedian %in% c("TRUE"), )
```
...
```{r}
fit_TIL_DR <- survfit(surv_DR_without_lac ~ TIL, data = MCP_Final_withoutLAC)
fit_TIL_short_DR <- survfit(surv_DR_without_lac ~ TILmedian, data = MCP_Final_withoutLAC)
fit_TIL5_DR <- survfit(surv_DR_without_lac ~ TIL5, data = MCP_Final_withoutLAC)
fit_TIL30_DR <- survfit(surv_DR_without_lac ~ TIL30, data = MCP_Final_withoutLAC)
fit_TIL50_DR <- survfit(surv_DR_without_lac ~ TIL50, data = MCP_Final_withoutLAC)
```

```{r, fig.width=7, fig.height=6}
ggsurvplot(fit_TIL_DR, data = MCP_Final_withoutLAC, pval = TRUE, legend = "top", legend.title = "TIL", palette = c("#a10702", "#ffb600", "#ff7900"), legend.labs = c("high", "low", "medium"), title = "DR - Univariate Analysis")

ggsurvplot(fit_TIL_short_DR, data = MCP_Final_withoutLAC, pval = TRUE, legend = "top", legend.title = "TIL", palette = c("#ffb600", "#a10702"), legend.labs = c("FALSE", "TRUE"), title = "DR TILmedian - Univariate Analysis")

ggsurvplot(fit_TIL5_DR, data = MCP_Final_withoutLAC, pval = TRUE, legend = "top", legend.title = "TIL", palette = c("#a10702", "#ffb600"), legend.labs = c("high", "low"), title = "DR TIL 5% - Univariate Analysis")

ggsurvplot(fit_TIL30_DR, data = MCP_Final_withoutLAC, pval = TRUE, legend = "top", legend.title = "TIL", palette = c("#a10702", "#ffb600"), legend.labs = c("high", "low"), title = "DR TIL 30% - Univariate Analysis")

ggsurvplot(fit_TIL50_DR, data = MCP_Final_withoutLAC, pval = TRUE, legend = "top", legend.title = "TIL", palette = c("#a10702", "#ffb600"), legend.labs = c("high", "low"), title = "DR TIL 50% - Univariate Analysis")
```
...
TIL_DRS_studygroup <- ggsurvplot(
    fit = survfit(Surv(time=time_DRS_months, event=distant_recurrence) ~ TILmedian + study_group, data = MCP_Final_withoutLAC), 
    xlab = "Months", 
    ylab = "DRS probability",
    title = "TIL median by study group",
    palette = c("#a10702", "#ffb600"),
...
TIL_DRS_studygroup_TIL5 <- ggsurvplot(
    fit = survfit(Surv(time=time_DRS_months, event=distant_recurrence) ~ TIL5 + study_group, data = MCP_Final_withoutLAC), 
    xlab = "Months", 
    ylab = "DRS probability",
    title = "TIL 5% by study group",
    palette = c("#a10702", "#ffb600"),
    ggtheme = theme_bw(),
    pval = T, facet.by = "study_group")
TIL_DRS_studygroup_TIL5

TIL_DRS_studygroup_TIL30 <- ggsurvplot(
    fit = survfit(Surv(time=time_DRS_months, event=distant_recurrence) ~ TIL30 + study_group, data = MCP_Final_withoutLAC), 
    xlab = "Months", 
    ylab = "DRS probability",
    title = "TIL 30%  by study group",
    palette = c("#a10702", "#ffb600"),
    ggtheme = theme_bw(),
    pval = T, facet.by = "study_group")
TIL_DRS_studygroup_TIL30

TIL_DRS_studygroup_TIL50 <- ggsurvplot(
    fit = survfit(Surv(time=time_DRS_months, event=distant_recurrence) ~ TIL50 + study_group, data = MCP_Final_withoutLAC), 
    xlab = "Months", 
    ylab = "DRS probability",
    title = "TIL 50% by study group",
    palette = c("#a10702", "#ffb600"),
...
TIL_per_studygroup_DRS_without_lac <- ggsurvplot(
    fit = survfit(Surv(time=time_DRS_months, event=distant_recurrence) ~ study_group + TILmedian, data = MCP_Final_withoutLAC ), 
    xlab = "Months", 
    ylab = "DRS probability",
...
TIL_per_studygroup_DRS_without_lac_TIL5 <- ggsurvplot(
    fit = survfit(Surv(time=time_DRS_months, event=distant_recurrence) ~ study_group + TIL5, data = MCP_Final_withoutLAC ), 
    xlab = "Months", 
    ylab = "DRS probability",
    title = "TIL 5% by study group",
    palette = c("#46CDCF", "#AA96DA", "#521262"),
    ggtheme = theme_bw(),
    pval = T, facet.by = "TIL5")
TIL_per_studygroup_DRS_without_lac_TIL5

TIL_per_studygroup_DRS_without_lac_TIL30 <- ggsurvplot(
    fit = survfit(Surv(time=time_DRS_months, event=distant_recurrence) ~ study_group + TIL30, data = MCP_Final_withoutLAC ), 
    xlab = "Months", 
    ylab = "DRS probability",
    title = "TIL 30% by study group",
    palette = c("#46CDCF", "#AA96DA", "#521262"),
    ggtheme = theme_bw(),
    pval = T, facet.by = "TIL30")
TIL_per_studygroup_DRS_without_lac_TIL30

TIL_per_studygroup_DRS_without_lac_TIL50 <- ggsurvplot(
    fit = survfit(Surv(time=time_DRS_months, event=distant_recurrence) ~ study_group + TIL50, data = MCP_Final_withoutLAC ), 
    xlab = "Months", 
    ylab = "DRS probability",
    title = "TIL 50% by study group",
    palette = c("#46CDCF", "#AA96DA", "#521262"),
    ggtheme = theme_bw(),
    pval = T, facet.by = "TIL50")
TIL_per_studygroup_DRS_without_lac_TIL50
```


### univariate
```{r}
cox_DR_TIL <- coxph(Surv(time_DRS_months, distant_recurrence) ~ TILmedian, data = MCP_Final_withoutLAC)
summary(cox_DR_TIL)

cox_DR_TIL_TIL5 <- coxph(Surv(time_DRS_months, distant_recurrence) ~ TIL5, data = MCP_Final_withoutLAC)
summary(cox_DR_TIL_TIL5)

cox_DR_TIL_TIL30 <- coxph(Surv(time_DRS_months, distant_recurrence) ~ TIL30, data = MCP_Final_withoutLAC)
summary(cox_DR_TIL_TIL30)

cox_DR_TIL_TIL50 <- coxph(Surv(time_DRS_months, distant_recurrence) ~ TIL50, data = MCP_Final_withoutLAC)
summary(cox_DR_TIL_TIL50)
```
...
```{r}
cox_DR_TIL_multivariate_short <- coxph(Surv(time_DRS_months, distant_recurrence) ~ TILmedian + study_group + stage + clin_subtype, data = MCP_Final_withoutLAC)
summary(cox_DR_TIL_multivariate_short)

cox_DR_TIL_multivariate_short_TIL5 <- coxph(Surv(time_DRS_months, distant_recurrence) ~ TIL5 + study_group + stage + clin_subtype, data = MCP_Final_withoutLAC)
summary(cox_DR_TIL_multivariate_short_TIL5)

cox_DR_TIL_multivariate_short_TIL30 <- coxph(Surv(time_DRS_months, distant_recurrence) ~ TIL30 + study_group + stage + clin_subtype, data = MCP_Final_withoutLAC)
summary(cox_DR_TIL_multivariate_short_TIL30)

cox_DR_TIL_multivariate_short_TIL50 <- coxph(Surv(time_DRS_months, distant_recurrence) ~ TIL50 + study_group + stage + clin_subtype, data = MCP_Final_withoutLAC)
summary(cox_DR_TIL_multivariate_short_TIL50)
```
