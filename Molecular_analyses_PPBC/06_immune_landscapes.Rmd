...
```{r}
immune_signature <- subset(immune_signature, cluster %in% c("ppbcpw", "prbc", "npbc"), )
```
...
ggboxplot(immune_signature_wound_healing, x="cluster", y="wound_healing",
          color = "cluster", palette = c("#46CDCF", "#AA96DA", "#521262"),
...
ANOVA_wound_healing <- ggboxplot(immune_signature_wound_healing, x="cluster", y="wound_healing",
  ...
  geom_dotplot(binaxis = "y", stackdir = "center", position = "dodge", binwidth = 0.00015, aes(colour = cluster)) + stat_compare_means(method = "kruskal") + ylim(0,0.01) + stat_pvalue_manual(pwc_wound_healing, hide.ns = TRUE, y.position = c(0.015))
ANOVA_wound_healing
```
...
ANOVA_IFNy_dominant <- ggboxplot(immune_signature_IFNy_dominant, x="cluster", y="IFNy_dominant",
  ...
  geom_dotplot(binaxis = "y", stackdir = "center", position = "dodge", binwidth = 0.001, aes(colour = cluster)) + stat_compare_means(method = "kruskal") + ylim(0, 0.06) + stat_pvalue_manual(pwc_IFNy_dominant, hide.ns = TRUE, y.position = c(0.06))
ANOVA_IFNy_dominant
```
...
ANOVA_inflammatory <- ggboxplot(immune_signature_inflammatory, x="cluster", y="inflammatory",
  ...
  geom_dotplot(binaxis = "y", stackdir = "center", position = "dodge", binwidth = 0.012, aes(colour = cluster)) + stat_compare_means(method = "wilcox.test") + ylim(0,0.75) + stat_pvalue_manual(pwc_inflammatory, hide.ns = TRUE, y.position = c(0.70, 0.74))
ANOVA_inflammatory
```
...
ANOVA_lymphocyte_depleted <- ggboxplot(immune_signature_lymphocyte_depleted, x="cluster", y="lymphocyte_depleted",
  ...
  geom_dotplot(binaxis = "y", stackdir = "center", position = "dodge", binwidth = 0.01, aes(colour = cluster)) + stat_compare_means(method = "wilcox.test") + ylim(0,0.75) + stat_pvalue_manual(pwc_lymphocyte_depleted, hide.ns = TRUE, y.position = c(0.73))
...
ANOVA_immunologically_quiet <- ggboxplot(immune_signature_immunologically_quiet, x="cluster", y="immunologically_quiet",
  ...
  geom_dotplot(binaxis = "y", stackdir = "center", position = "dodge", binwidth = 0.0000005, aes(colour = cluster)) + stat_compare_means(method = "kruskal") + ylim(0,0.00012) + stat_pvalue_manual(pwc_immunologically_quiet, hide.ns = TRUE, y.position = c(0.00012))
...
ANOVA_TGFb_dominant <- ggboxplot(immune_signature_TGFb_dominant, x="cluster", y="TGFb_dominant",
  ...
  geom_dotplot(binaxis = "y", stackdir = "center", position = "dodge", binwidth = 0.0005, aes(colour = cluster)) + stat_compare_means(method = "kruskal") + ylim(0,0.025) + stat_pvalue_manual(pwc_TGFb_dominant, hide.ns = TRUE, y.position = c(0.025))
ANOVA_TGFb_dominant
```
...
ggboxplot(immune_signature_ppbcpw, x="BestCall", y="fraction_bestcall",
          color = "BestCall", #palette = c("#46CDCF", "#AA96DA", "#521262"),
          order = c(1,2,3,4,5,6),
