...
Cibersort_PC <- ggboxplot(MCP_IG, x="study_group", y="Plasma_fraction",
  ...
  geom_dotplot(binaxis = "y", stackdir = "center", position = "dodge", binwidth = 0.005, aes(colour = study_group)) + stat_compare_means(method = "anova") + ylim(0,0.3) + stat_pvalue_manual(pwc, hide.ns = TRUE, y.position = c(0.27, 0.28, 0.3))
Cibersort_PC
```
...
```{r}
ggboxplot(MCP_IG, x="study_group", y="memory_B_fraction",
          color = "study_group", palette = c("#46CDCF", "#112D4E", "#AA96DA", "#521262"),
          order = c("ppbcpw", "ppbcdl", "prbc", "npbc"),
          ylab = "memoryB Fraction", xlab = "B-cell related expression") + 
  geom_dotplot(binaxis = "y", stackdir = "center", position = "dodge", binwidth = 0.005, aes(colour = study_group)) + stat_compare_means(method = "kruskal") + ylim(0,0.3) + stat_pvalue_manual(pwc_memB, hide.ns = TRUE, y.position = c(0.20))
```
...
```{r}
Boxplot_naiveB <- ggboxplot(MCP_IG, x="study_group", y="naive_B_fraction",
          color = "study_group", palette = c("#46CDCF", "#112D4E", "#AA96DA", "#521262"),
          order = c("ppbcpw", "ppbcdl", "prbc", "npbc"),
...
```{r}
Boxplot_CD8_fraction <- ggboxplot(MCP_IG, x="study_group", y="CD8_fraction",
          color = "study_group", palette = c("#46CDCF", "#112D4E", "#AA96DA", "#521262"),
          order = c("ppbcpw", "ppbcdl", "prbc", "npbc"),
