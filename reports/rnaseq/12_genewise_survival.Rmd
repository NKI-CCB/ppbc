...
print(paste(basename(params$survival_results), ":", analysis_type))
```

---
title: '`r paste("Genewise survival report:", analysis_type)`'
---
...
Threshold selection.
Pick the minimum threshold that has at least 50 hits for exploration.
