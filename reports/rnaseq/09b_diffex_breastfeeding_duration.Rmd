...
```{r DESeq}
ddsfile = here("data/rnaseq/processed/09b_dds_breastfeeding_duration.Rds")
...
```{r}
apefile = here("data/rnaseq/processed/09b_ape_breastfeeding_duration.Rds")
...
write.xlsx(resdf, file = here(resDir, "09b_diffex_breastfeeding_duration.xlsx"))
rm(resdf)
```
...
```{r}
pdf(file.path(resDir, "09b_hm_breastfeeding_duration.pdf"), width = 10, height = 8)
...
```{r}
pdf(file.path(resDir,"09b_volcano_breastfeeding_duration.pdf"),
    height = 6, width = 8)
vp
dev.off()
```
