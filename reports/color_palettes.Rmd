...
```{r}
pam_colors = suppressWarnings(colorRampPalette(brewer.pal(length(unique(dds$PAM50)),"Paired"))(length(unique(dds$PAM50))))
#names(pam_colors)= levels(dds$PAM50) #Change the order
names(pam_colors) = c(
  "Basal",
  "Normal",
  "LumA",
...
saveRDS(list(study_colors = study_colors,
        ...
        here("data", "Rds", "color_palettes.Rds"))
```
