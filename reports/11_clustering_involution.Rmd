...
deseq_heatmap(mat = geneEx, sampledata = tsd,
              ...
              column_km=3, row_km = 3, top_colors = bf_col)
```
...
todo: collapse cluster 2 into single metagene by averaging experession, then test assocation between metagene and survival/subgroups
...
coldend.hm = column_dend(draw(inv.hm))
test_clust =
bind_rows(
