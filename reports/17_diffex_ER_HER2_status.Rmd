...
We want the p value between ER status and study group to be high to avoid colinearity within the differential expression design formula. Using ER status, we can hopefully avoid colinearity without completely ignoring PAM50 subtypes.
