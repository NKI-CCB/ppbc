...
```{r, fig.height=7, fig.width=12}
rt_fig4e2 <- risktable(fig4e2, response = "delta_l")
rt_fig4e2
```
...
```{r}
write_csv(fig4e2$data, here(params$rt_fig4e))
```
...
```{r, fig.height=7, fig.width=12}
rt_fig4f2 <- risktable(fig4f2, response = "delta_l")
rt_fig4f2
```
...
```{r}
write_csv(fig4f2$data, here(params$rt_fig4f))
```
...
```{r, fig.height=7, fig.width=12}
rt_fig4g2 <- risktable(fig4g2, response = "delta_l")
rt_fig4g2
```
...
```{r}
write_csv(fig4g2$data, here(params$rt_fig4g))
```
...
```{r, fig.height=7, fig.width=12}
rt_fig4h2 <- risktable(fig4h2, response = "delta_l")
rt_fig4h2
```
...
```{r}
write_csv(fig4h2$data, here(params$rt_fig4h))
```
...
```{r, fig.height=7, fig.width=12}
rt_fig4i2 <- risktable(fig4i2, response = "delta_l")
rt_fig4i2
```
...
```{r}
write_csv(fig4i2$data, here(params$rt_fig4i))
```
