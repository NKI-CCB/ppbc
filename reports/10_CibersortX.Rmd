...
Note: At this time (30/4/20), some of the elements in box plots are overlapping.
...
```{r}
ciber_input = read_csv(here("results", "cibersortX", "CIBERSORTx_Job3_Results.csv"))
abs_ciber_input = read_csv(here("results", "cibersortX", "CIBERSORTx_Job4_Results.csv"))
head(ciber_input)
```
...
ciberdf = ciber_input %>%
  ...
  left_join(., select(meta, sample_name, study_group, PPBC,
                      ...
                      stage=stage_short_integer, grade,
...
surv_type = surv_type %>%
  ...
  ))) %>% mutate(overall_survival = as.integer(overall_survival))
...
coxph(
  Surv(time=months_overall_survival,
       event=overall_survival) ~ age_at_diagnosis + grade + stage + surgery + radiotherapy + strata(hormonetherapy) + chemotherapy + herceptin + strata(PAM50) + PPBC + plasmaB,
  data = surv_type) %>%
...
names(bcolors) = paste0("plasmaB=", names(cp$tertile_colors))
  ...
  ggsurvplot(
    fit = survfit(Surv(time=months_overall_survival, event=overall_survival) ~ plasmaB, data = surv_type), 
    xlab = "Months", 
...
names(bcolors) = paste0("plasmaB=", names(cp$tertile_colors))
  ...
  ggsurvplot(
    fit = survfit(Surv(time=months_overall_survival, event=overall_survival) ~ plasmaB, data = st2), 
    xlab = "Months", 
    ylab = "Overall survival probability",
    title = "Plasma B tertiles",
    palette = bcolors,
...
p =  ggsurvplot(
    fit = survfit(Surv(time=months_overall_survival, event=overall_survival) ~ PPBC + plasmaB, data = as.data.frame(surv_type)), 
    xlab = "Months", 
    ylab = "Overall survival probability",
    title = "Plasma B tertiles",
    #palette = bcolors,
...
p$plot +
    ...
    ggsurvplot(
    fit = survfit(Surv(time=months_overall_survival, event=overall_survival) ~ plasmaB, data = as.data.frame(surv_type)), 
    xlab = "Months", 
    ylab = "Overall survival probability",
    title = "Plasma B tertiles",
    palette = bcolors,
...
for(sg in unique(surv_type$PPBC)){
  p = ggsurvplot(
    fit = survfit(Surv(time=months_overall_survival, event=overall_survival) ~ plasmaB, data = surv_type[surv_type$PPBC == sg, , drop=F]), 
    xlab = "Months", 
    ylab = "Overall survival probability",
...
for(sg in unique(st2$PPBC)){
  p = ggsurvplot(
    fit = survfit(Surv(time=months_overall_survival, event=overall_survival) ~ plasmaB, data = st2[st2$PPBC == sg, , drop=F]), 
    xlab = "Months", 
    ylab = "Overall survival probability",
    title = paste0("PPBC:", sg),
    palette = bcolors,
...
coxph(
  Surv(time=months_overall_survival,
       event=overall_survival) ~ age_at_diagnosis + grade + stage + surgery + radiotherapy + strata(hormonetherapy) + chemotherapy + herceptin + PAM50 + PPBC + plasmaB,
  data = surv_type) %>%
...
coxph(
  Surv(time=months_overall_survival,
       event=overall_survival) ~ age_at_diagnosis + grade + stage + surgery + radiotherapy + strata(hormonetherapy) + chemotherapy + herceptin + strata(PAM50) + PPBC + CD8_exp,
  data = surv_type) %>%
...
coxph(
  Surv(time=months_overall_survival,
       event=overall_survival) ~ age_at_diagnosis + grade + stage + surgery + radiotherapy + strata(hormonetherapy) + chemotherapy + herceptin + strata(PAM50) + PPBC + CD8,
  data = surv_type) %>%
...
names(tcolors) = paste0("CD8=", names(cp$tertile_colors))
  ...
  ggsurvplot(
    fit = survfit(Surv(time=months_overall_survival, event=overall_survival) ~ CD8, data = surv_type), 
    xlab = "Months", 
    ylab = "Overall survival probability",
...
for(sg in unique(surv_type$PPBC)){
  p = ggsurvplot(
    fit = survfit(Surv(time=months_overall_survival, event=overall_survival) ~ CD8, data = surv_type[surv_type$PPBC == sg, , drop=F]), 
    xlab = "Months", 
    ylab = "Overall survival probability",
    title = paste0("PPBC:", sg),
    palette = tcolors,
...
coxph(
  Surv(time=months_overall_survival,
       event=overall_survival) ~ age_at_diagnosis + grade + stage + surgery + radiotherapy + strata(hormonetherapy) + chemotherapy + herceptin + PAM50 + PPBC + CD8,
  data = surv_type) %>%
...
coxph(
  Surv(time=months_overall_survival,
       event=overall_survival) ~ age_at_diagnosis + grade + stage + surgery + radiotherapy + strata(hormonetherapy) + chemotherapy + herceptin + strata(PAM50) + PPBC + M2_exp,
  data = surv_type) %>%
...
coxph(
  Surv(time=months_overall_survival,
       event=overall_survival) ~ age_at_diagnosis + grade + stage + surgery + radiotherapy + strata(hormonetherapy) + chemotherapy + herceptin + strata(PAM50) + PPBC + M2,
  data = surv_type) %>%
...
names(tcolors) = paste0("M2=", names(cp$tertile_colors))
  ...
  ggsurvplot(
    fit = survfit(Surv(time=months_overall_survival, event=overall_survival) ~ M2, data = surv_type), 
    xlab = "Months", 
    ylab = "Overall survival probability",
...
for(sg in unique(surv_type$PPBC)){
  p = ggsurvplot(
    fit = survfit(Surv(time=months_overall_survival, event=overall_survival) ~ M2, data = surv_type[surv_type$PPBC == sg, , drop=F]), 
    xlab = "Months", 
    ylab = "Overall survival probability",
    title = paste0("PPBC:", sg),
    palette = tcolors,
...
coxph(
  Surv(time=months_overall_survival,
       event=overall_survival) ~ age_at_diagnosis + grade + stage + surgery + radiotherapy + strata(hormonetherapy) + chemotherapy + herceptin + PAM50 + PPBC + M2,
  data = surv_type) %>%
