...
#testing
 km_plot(cox_dens, panel = "MPIF26", cell_type = "CD20+", outcome,
...
Interaction term between group and cell density. Maybe be statistically underpowered due to lack of more samples.
...
#testing
cox_interaction(cox_dens, "MPIF26", "CD20+", baseform = multiv_subform, testing = T)
cox_interaction(cox_dens, "MPIF26", "CD20+", baseform = multiv_subform)
```
