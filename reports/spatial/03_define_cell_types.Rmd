...
correct_double_positivity <- function(df, blacklist, verbose=T){
  ...
  pos1 <- paste0(marker1,"_pos")
  pos2 <- paste0(marker2,"_pos")
  ...
  ind <- df[,paste0(marker1,"_pos")] & df[,paste0(marker2,"_pos")]
...
for(i in 1:length(disallowed_markers)){
  m1 <- paste0(disallowed_markers[[i]][1], "_pos")
  m2 <- paste0(disallowed_markers[[i]][2], "_pos")
