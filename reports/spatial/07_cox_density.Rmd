...
---
title: '`r paste('Cox regression with cell density:', ptitle)`'
---
...
filter_cell_groups <- function(df = dens, cellgroups = agg_cells, show_cell_subgroups){
  ...
  if(show_cell_subgroups){
    ...
    #print("MPIF27:")
    #print(paste("Including cell subtypes:", paste0(mpif27_subgroups, collapse = ", ")))
    #print(paste("Excluding parent groups:", paste0(mpif27_parents, collapse = ", ")))
    #df <- df[-which(df$panel == "MPIF27" & df$cell_type %in% mpif27_parents),]
  } else {
    print("MPIF26:")
    ...
    #print("MPIF27:")
    #print(paste("Excluding cell subtypes:", paste0(mpif27_subgroups, collapse = ", ")))
    #print(paste("Including parent groups:", paste0(mpif27_parents, collapse = ", ")))
    #df <- df[-which(df$panel == "MPIF27" & df$cell_type %in% mpif27_subgroups),]
  }
